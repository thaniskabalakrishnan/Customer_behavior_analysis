...
--Compare average spend and total revenue betweer subscribers and non-subscribers
...
when previous_purchases between 2 and 10 then 'returing'else 'loyal' end as customer_segment
from customer)
